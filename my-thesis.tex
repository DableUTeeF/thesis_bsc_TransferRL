...
\usepackage[top=25mm, bottom=20mm, left=1.5in, right=20mm]{geometry}
\XeTeXlinebreaklocale "th"
\XeTeXlinebreakskip = 0pt plus 1pt
\defaultfontfeatures{Scale=1.33}
...
%\newfontfamily{\engfont}[Script=English]{TH SarabunPSK}
\setmainfont{TH SarabunPSK} 
\setsansfont{TH SarabunPSK} 
\setmonofont{TH SarabunPSK}
...
\end{small}
\addcontentsline{lof}{figure}{Figure 1: MCTS outputs}
\begin{center}
\includegraphics[width=0.75\textwidth]{MCTS.png}\par
\end{center}
\begin{small}
...
\end{small}
\addcontentsline{lof}{figure}{Figure 2: AlphaGo Zero MCTS search}
\clearpage
...
\begin{center}
\includegraphics[width=0.75\textwidth]{ResNet.png}\par
\begin{small}
Figure 3: Network Architecture.\par
\end{small}
\addcontentsline{lof}{figure}{Figure 3: Network Architecture}
\end{center}
\begin{center}
...
\end{small}
\end{center}
\addcontentsline{lof}{figure}{Figure 4: Shared Learning Network Architecture}
\clearpage
...
\end{small}
\end{center}
\addcontentsline{lot}{table}{Table 1: The Train Server specification}
}
...
\end{small}
\end{center}
\addcontentsline{lot}{table}{Table 2: Match result}
}
\section{Shared Learning}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{Fig5.png}\par
\end{center}
\begin{small}
...
\end{small}
\addcontentsline{lof}{figure}{Figure 5: The detailed win percentage of the Shared Learning}
\clearpage

\begin{center}
\includegraphics[width=1.0\textwidth]{N34-C34-1.png}\par
\end{center}
\begin{small}
Figure 6: Normal model version 34 vs Transferred Learning version 34. Normal model plays black.\par
\end{small}
\addcontentsline{lof}{figure}{Figure 6: Normal model version 34 vs Transferred Learning version 34}
\clearpage

\begin{center}
\includegraphics[width=1.0\textwidth]{N34-C34-2.png}\par
\end{center}
\begin{small}
Figure 7: Normal model version 34 vs Transferred Learning version 34.\par
\end{small}
\addcontentsline{lof}{figure}{Figure 7: Normal model version 34 vs Transferred Learning version 34}
\clearpage
\begin{center}
\includegraphics[width=1.0\textwidth]{C34-N34-1.png}\par
\end{center}
\begin{small}
Figure 8: Transferred Learning version 34 vs Normal model version 34. Transferred Learning plays black.\par
\end{small}
\addcontentsline{lof}{figure}{Figure 8: Transferred Learning version 34 vs Normal model version 34}
\clearpage

\begin{center}
\includegraphics[width=1.0\textwidth]{C34-N34-2.png}\par
\end{center}
\begin{small}
...
\end{small}
\addcontentsline{lof}{figure}{Figure 9: Transferred Learning version 34 vs Normal model version 34}
\clearpage

\begin{center}
\includegraphics[width=1.0\textwidth]{N2-S47-1.png}\par
\end{center}
\begin{small}
Figure 10: Normal model 2nd version vs Shared Learning 47th version. Normal model plays black.\par
\end{small}
\addcontentsline{lof}{figure}{Figure 10: Normal model 2nd version vs Shared Learning 47th version}
\clearpage

\begin{center}
\includegraphics[width=1.0\textwidth]{N2-S47-2.png}\par
\end{center}
\begin{small}
...
\end{small}
\addcontentsline{lof}{figure}{Figure 11: Continue, Normal model 2nd version vs Shared Learning 47th version}
\clearpage
